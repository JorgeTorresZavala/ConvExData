...
<?php 
  ...
  if(!file_exists ($rutaDelArchivo)) echo "El archivo no Existe";
    ...
    try { 
      ...
      $sentencia = $conexion->prepare("INSERT INTO expop_RT2 (DEV,POS) VALUES (:DEV,:POS)");
      ...
      while (!feof($recurso)) { 
        ...
        //Datos iniciales...
        echo "<pre>";
        $Pos_DEV=strpos($linea, "RT2-");
        $Pos_Guion=strrpos($linea, "-");
        //echo "La posición del RT2 es: ".$Pos_DEV."<br>";
        //echo "La posición del Guión es: ".$Pos_Guion."<br>";
