                    ...
                    <div class="card-body">
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="AreaOperativa">
                          ...
                          <option value="7">ENSENADA</option>
                          <option value="8">MEXICALI</option>
                          <option value="9">ROSARITO</option>
                          <option value="10">SAN LUIS</option>
                          <option value="11">TECATE</option>
                          <option value="12">TIJUANA</option>
                        </select>                        
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="Central">
                          ...
                          <option value="8">Lomas</option>
                          <option value="9">Otay</option>
                          <option value="10">Pío Pico</option>
                          <option value="11">Playas</option>
                          <option value="12">Anáhuac</option>
                        </select>                        
                      </div>  <!-- Opción: /Central -->
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="NomCorto">
                          ...
                          <option value="9">OTY</option>
                          <option value="10">PIO</option>
                          <option value="11">PLY</option>
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="CLLI">
                          ...
                          <option value="7">ANAHUAC</option>
                          <option value="8">TIJNXBLODS1</option>
                          <option value="9">TIJNXBOTDS1O</option>
                          <option value="10">TIJNXBPPDS1</option>
                          <option value="11">TIJNXBPLDS1</option>
                        </select>                        
                      </div>  <!-- Opción: /CLLI -->
                    </div>  
                    ...
                    <div class="card-body">
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="Municipio">
                          ...
                          <option value="6">Otay</option>
                          <option value="7">Playas</option>
                          <option value="8">Anáhuac</option>
                          <option value="9">Lomas</option>
                        </select>                        
                      ...
                      <div class="input-group mb-2">
                        ...
                        <select class="custom-select" id="Localidad">
                          ...
                          <option value="5">Centro Cívico</option>
                          <option value="6">Fracc. Playas</option>
                          <option value="7">López Mateos</option>
                          <option value="8">Aeropuerto</option>
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="Impresos" id="SSS" checked>
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="Impresos" id="GSS">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="Impresos" id="TSS">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="Impresos" id="CPS">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="Impresos" id="IOG">
                      ...
                      <div class="input-group">
                        <form action = "http://localhost/ConvExData/controllers/Proc_EXEDP.php" method="post" enctype="multipart/form-data">
                            ...
                            <input type="file" name="file_EXEDP" id="inputGroupFile02">
                ...
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="input-group">
                        <form action = "http://localhost/ConvExData/controllers/Proc_STBSP.php" method="post" enctype="multipart/form-data">                        
                          <input type="file" name="file_STBSP" id="file_STBSP">                       
                          <button class="btn btn-outline-primary" type="submit">Enviar</button>                         
                        </form>
                      </div>
                      ...
                      <div class="input-group">
                        <form action = "http://localhost/ConvExData/controllers/Proc_SAAEP.php" method="post" enctype="multipart/form-data">                        
                          <input type="file" name="file_SAAEP" id="file_SAAEP">                        
                          <button class="btn btn-outline-primary" type="submit">Enviar</button>
                        </form>
                      </div>
