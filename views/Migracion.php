 ...
 <!-- Encabezado -->
  <div class="container">       
    <div class="row justify-content-center pt-5">
      <h3 class="display-4" style=color:#0E8744;>MIGRACIÓN</h3>
    </div>      
    <div class="row justify-content-center pb-2 sticy-top">
      <h3>
        <small>(Cambiar EMGs(RSS/CSS/EAR) de una central a otra)</small>
      </h3>
    </div>
  </div>  <!-- /Encabezado -->
  <hr>
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Central GUEST (Donante)...</h5>
                      <p class="card-text">Selecciona el tipo de impresos</p>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3G" id="EXEDP_GUEST" value="">
                        <label class="form-check-label" for="EXEDP">
                          EXEDP (Equipo y Software del EMG)
                        </label>
                      </div>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3G" id="STDEP_LI3_GUEST" value="">
                        <label class="form-check-label" for="STDEP_LI3_GUEST">
                          STDEP (Impresos de LI3s del EMG)
                        </label>
                      </div>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3G" id="STDEP_LIMA_GUEST" value="">
                        <label class="form-check-label" for="STDEP_LIMA_GUEST">
                          STDEP (Impresos de LIMAs del EAR)
                        </label>
                      </div>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3G" id="SUSCP_GUEST" value="">
                        <label class="form-check-label" for="SUSCP_GUEST">
                          SUSCP (Impreso de categorías)
                        </label>
                      </div>
                ...
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Central HOST (Receptora)</h5>
                      <p class="">Seleccione el tipo de impresos...</p>
                      
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3H" id="STDEP_LI3_HOST" value="">
                        <label class="form-check-label" for="STDEP_LI3">
                            STDEP (Impresos de LI3s del EMG)
                        </label>
                      </div>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3H" id="STDEP_LIMA_HOST" value="">
                        <label class="form-check-label" for="STDEP_LIMA">
                            STDEP (Impresos de LIMAs del EAR)
                        </label>
                      </div>

                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="LI3H" id="SUSCP_HOST" value="">
                        <label class="form-check-label" for="SUSCP">
                            SUSCP (Impreso de categorías)
                        </label>
                      </div>
